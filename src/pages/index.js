...
import realt from "../assets/img/icons/realt.svg"
import bitsgap from "../assets/img/icons/bitsgap.svg"
import softeco from "../assets/img/icons/softeco.svg"
      ...
      <div className="background">
        <div className="first-page">
          ...
          <div className="button">
            <Link to="/form"><button>Book a meeting</button></Link>
          </div>
        </div>
