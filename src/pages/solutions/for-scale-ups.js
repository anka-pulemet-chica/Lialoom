        ...
        <Layout>
            <div className="linearbg">
                <div className="paired">
                    ...
                    <div><p>We understand that establishing and managing in-house sales teams can be demanding in terms
                        of resources and time for scale-ups and small to medium-sized businesses. If you're experiencing either rapid or delayed growth, it can divert your attention from core business functions to the pursuit of an efficient sales infrastructure and approach.
                        Whether you find yourself navigating a competitive maze or you are in search of an external
                        perspective, we can help.</p>
                    </div>
                ...
                <div className="why">
                    <h3>Why Sales Outsourcing for Scale-ups and SMBs?</h3>
                    <div className="picbox">
                        <div className="box">
